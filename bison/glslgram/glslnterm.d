...
import bison.glslgram.array_specifier;
import bison.glslgram.assignment_expression;
import bison.glslgram.assignment_operator;
import bison.glslgram.attribute_list;
import bison.glslgram.case_label;
import bison.glslgram.compound_statement_no_new_scope;
import bison.glslgram.compound_statement;
import bison.glslgram.condition;
import bison.glslgram.conditional_expression;
import bison.glslgram.conditionopt;
import bison.glslgram.declaration;
import bison.glslgram.equality_expression;
import bison.glslgram.exclusive_or_expression;
import bison.glslgram.expression_statement;
import bison.glslgram.expression;
import bison.glslgram.external_declaration;
import bison.glslgram.for_init_statement;
import bison.glslgram.for_rest_statement;
import bison.glslgram.fully_specified_type;
...
import bison.glslgram.function_declarator;
import bison.glslgram.function_header_with_parameters;
import bison.glslgram.function_identifier;
import bison.glslgram.function_prototype;
import bison.glslgram.identifier_list;
import bison.glslgram.inclusive_or_expression;
import bison.glslgram.init_declarator_list;
import bison.glslgram.initializer_list;
...
import bison.glslgram.iteration_statement;
import bison.glslgram.jump_statement;
import bison.glslgram.layout_qualifier_id_list;
import bison.glslgram.layout_qualifier_id;
import bison.glslgram.logical_and_expression;
import bison.glslgram.logical_or_expression;
import bison.glslgram.logical_xor_expression;
import bison.glslgram.multiplicative_expression;
import bison.glslgram.parameter_declaration;
import bison.glslgram.parameter_declarator;
import bison.glslgram.postfix_expression;
import bison.glslgram.precision_qualifier;
import bison.glslgram.primary_expression;
import bison.glslgram.relational_expression;
import bison.glslgram.selection_rest_statement;
import bison.glslgram.selection_statement;
import bison.glslgram.shift_expression;
import bison.glslgram.simple_statement;
import bison.glslgram.single_attribute;
import bison.glslgram.single_declaration;
import bison.glslgram.single_type_qualifier;
import bison.glslgram.spirv_capability_list;
import bison.glslgram.spirv_decorate_id_parameter;
import bison.glslgram.spirv_decorate_parameter_list;
import bison.glslgram.spirv_decorate_parameter;
import bison.glslgram.spirv_decorate_qualifier;
import bison.glslgram.spirv_decorate_string_parameter_list;
import bison.glslgram.spirv_execution_mode_id_parameter_list;
import bison.glslgram.spirv_execution_mode_parameter_list;
import bison.glslgram.spirv_execution_mode_parameter;
import bison.glslgram.spirv_execution_mode_qualifier;
import bison.glslgram.spirv_extension_list;
import bison.glslgram.spirv_instruction_qualifier_id;
import bison.glslgram.spirv_instruction_qualifier_list;
import bison.glslgram.spirv_instruction_qualifier;
import bison.glslgram.spirv_requirements_list;
import bison.glslgram.spirv_requirements_parameter;
import bison.glslgram.spirv_storage_class_qualifier;
import bison.glslgram.spirv_type_parameter_list;
import bison.glslgram.spirv_type_parameter;
import bison.glslgram.spirv_type_specifier;
import bison.glslgram.statement_list;
import bison.glslgram.statement_no_new_scope;
import bison.glslgram.statement_scoped;
import bison.glslgram.statement;
import bison.glslgram.storage_qualifier;
import bison.glslgram.struct_declaration_list;
import bison.glslgram.struct_declaration;
import bison.glslgram.struct_declarator_list;
import bison.glslgram.struct_declarator;
import bison.glslgram.struct_specifier;
import bison.glslgram.switch_statement_list;
import bison.glslgram.switch_statement;
import bison.glslgram.translation_unit;
import bison.glslgram.type_name_list;
import bison.glslgram.type_parameter_specifier_list;
import bison.glslgram.type_parameter_specifier_opt;
import bison.glslgram.type_qualifier;
import bison.glslgram.type_specifier_nonarray;
import bison.glslgram.type_specifier;
